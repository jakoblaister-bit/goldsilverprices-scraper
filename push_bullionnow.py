"""
push_bullionnow.py
Scrapes Bullion Now, deletes existing rows, inserts fresh data.

Run:  python push_bullionnow.py
Disable in push_all.py: comment out the Bullion Now entry in the dealers list.
"""

import json, urllib.request, urllib.error
from datetime import datetime, timezone
from scrape_bullionnow import fetch_products, DEALER
