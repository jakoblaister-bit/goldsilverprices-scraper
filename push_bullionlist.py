"""
push_bullionlist.py
Scrapes BullionList, deletes existing rows, inserts fresh data.

Run:  python push_bullionlist.py
Disable in push_all.py: comment out the BullionList entry in the dealers list.
"""

import json, urllib.request, urllib.error
from datetime import datetime, timezone
from scrape_bullionlist import fetch_products, DEALER
