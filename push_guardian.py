"""
push_guardian.py
Scrapes Guardian Gold via paginated WooCommerce shop, deletes all existing
Guardian Gold rows, bulk-inserts fresh data.

Run:  python push_guardian.py
"""

import json, urllib.request, urllib.error
from datetime import datetime, timezone
from scrape_guardian import fetch_products, DEALER
