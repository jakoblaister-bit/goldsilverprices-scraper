"""
push_jaggards.py
Scrapes Jaggards via WP sitemap, deletes all existing Jaggards rows,
bulk-inserts fresh data.

Run:  python push_jaggards.py
"""

import json, urllib.request, urllib.error
from datetime import datetime, timezone
from scrape_jaggards import fetch_products, DEALER
