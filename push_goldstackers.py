"""
push_goldstackers.py
Scrapes goldstackers.com.au/live-charts-prices/, deletes all existing
Gold Stackers rows, then bulk-inserts fresh data.

Run:  python push_goldstackers.py
"""

import json, urllib.request, urllib.error
from datetime import datetime, timezone
from scrape_goldstackers import fetch_products, DEALER
