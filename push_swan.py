"""
push_swan.py
Scrapes swanbullion.com gold + silver category pages, deletes all existing
Swan Bullion rows, then bulk-inserts fresh data.

Run:  python push_swan.py
"""

import json, urllib.request, urllib.error
from datetime import datetime, timezone
from scrape_swan import fetch_products, DEALER
